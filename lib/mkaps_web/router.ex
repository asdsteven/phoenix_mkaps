defmodule MkapsWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {MkapsWeb.Layouts, :root}
  ...
  # scope "/api", MkapsWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:mkaps, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MkapsWeb.Telemetry
